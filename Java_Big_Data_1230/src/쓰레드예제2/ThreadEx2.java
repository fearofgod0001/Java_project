...
/*
*  - 상속 받는 방법
*  - extends Thread : 구현이 쉬움, 다른 상속 못받음
...
public class ThreadEx2 {
    public static void main(String[] args) {
       ...
       clsTh1.start(); //내부적으로 run()메소드가 호출 됨
        ...
        Runnable run1 = new RunThread(); //수행해야 할 작업 내용은 포함하고 있지만 실제 쓰레드는 아님
        Thread runTh1 = new Thread(run1);
        Thread runTh2 = new Thread(run1);
        runTh1.start();
        runTh2.start();
